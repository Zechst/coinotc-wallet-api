...
contract CoinOTCToken is PausableToken {
    string  public  constant name = "CoinOTCToken";
    ...
    function CoinOTCToken( address _admin, uint _totalTokenAmount ) public
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to coinotc token
